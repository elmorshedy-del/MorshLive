...
(function (global) {
  ...
  const DICT = {
    ar: {
      ...
      "tv.feat2desc": "قائمة مباريات كبيرة — صف واحد لكل مباراة. تنقّل بأسهم الريموت للأعلى والأسفل واضغط OK للتشغيل، مثل تطبيق تلفزيون حقيقي.",
      ...
      "tv.device4": "Apple TV",
      "tv.lbHint": "↑↓ للتنقّل بين المباريات · OK للمشاهدة",
      "tv.lbVs": "×",
    ...
    en: {
      ...
      "tv.feat2desc": "A big match list — one row per match. Move up and down with the remote, press OK to play — like a real TV app.",
      ...
      "tv.device3": "Amazon Fire TV",
      "tv.device4": "Apple TV",
      "tv.lbHint": "↑↓ between matches · OK to watch",
      "tv.lbVs": "vs",
