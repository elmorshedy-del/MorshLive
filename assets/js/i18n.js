...
(function (global) {
  ...
  const DICT = {
    ar: {
      ...
      "home.recentTweetsTitle": "ترند X — @TrollFootball و @memesvsfootball",
      "home.recentTweetsLede": "آخر 50 تغريدة لكل حساب — نعرض أعلى 75٪ حسب الإعجابات فقط (صور وفيديو)، مرتبة من الأحدث.",
    ...
    en: {
      ...
      "home.recentTweetsTitle": "Trending on X — @TrollFootball & @memesvsfootball",
      "home.recentTweetsLede": "Last 50 posts per account — only the top 75% by likes (photo/video), newest first.",
