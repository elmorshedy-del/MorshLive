...
(function (global) {
  ...
  const DICT = {
    ar: {
      ...
      "watch.altStreamsNote": "مشغّلات احتياطية منفصلة — لا ترتبط بأزرار القنوات والسيرفرات أعلاه.",
    ...
    en: {
      ...
      "watch.altStreamsNote": "Separate backup players — not tied to the channel and server pickers above.",
      "watch.altSirTv": "Sir TV",
      "watch.altNtv": "NTV",
      "watch.altKooraCity": "Koora City",
      "watch.altAmine": "Amine",
