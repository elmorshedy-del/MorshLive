...
(function (global) {
  ...
  const DICT = {
    ar: {
      ...
      "home.recentTweetsTitle": "ترند X — اليوم",
      "home.recentTweetsLede": "ميمات اليوم فقط من @TrollFootball و @memesvsfootball — لكل حساب حد إعجابات محسوب منذ انطلاق المونديال (~٤ يومياً لكل حساب).",
    ...
    en: {
      ...
      "home.recentTweetsTitle": "Trending on X — today",
      "home.recentTweetsLede": "Today's memes only from @TrollFootball & @memesvsfootball — per-account likes threshold since World Cup kickoff (~4/day each).",
