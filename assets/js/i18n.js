...
(function (global) {
  ...
  const DICT = {
    ar: {
      ...
      "nav.tournament": "ملخص المباريات و التويتات الخاصة بها",
      ...
      "watch.disclaimer": 'اختر <b>مصدر البث</b> أعلى الفيديو — المظلّل بالأخضر يعمل. للمباريات على MAX جرّب <b>VIP الاحتياطي</b> إذا كان البث خاطئاً.',
      "watch.sources": "مصادر البث",
      "watch.optAuto": "تلقائي",
      "watch.optAutoHint": "بث مباشر + Twitch — الأفضل لمعظم المباريات",
      ...
      "watch.optMaxArHint": "قناة beIN MAX العربية على dlhd — قد لا تعمل دائماً",
      "watch.optSportsAr": "سبورتس عربي · احتياطي",
      "watch.optSportsArHint": "ليست قناة MAX — بث سبورتس عربي 24/7 كاحتياطي فقط",
      "watch.optDlhdSports1": "سبورتس 1 · dlhd",
      "watch.optDlhdSports2": "سبورتس 2 · dlhd",
      "watch.optDlhdBackup": "dlhd احتياطي",
      "watch.optDlhdBackupHint": "بث dlhd 24/7 — احتياطي عند تعطل المصدر الرئيسي",
    ...
    en: {
      ...
      "nav.faq": "FAQ",
      "nav.live": "Live",
      "nav.tournament": "Match highlights & tweets",
      ...
      "watch.disclaimer": 'Pick a <b>stream source</b> above the player — green means it works. For MAX games, try <b>alt VIP</b> if you see the wrong match.',
      "watch.sources": "Stream sources",
      "watch.optAuto": "Auto",
      "watch.optAutoHint": "HLS + Twitch — best for most matches",
      ...
      "watch.optMaxArHint": "beIN MAX Arabic on dlhd — not always online",
      "watch.optSportsAr": "Sports AR · backup",
      "watch.optSportsArHint": "NOT a MAX channel — 24/7 Arabic Sports backup only",
      "watch.optDlhdSports1": "Sports 1 · dlhd",
      "watch.optDlhdSports2": "Sports 2 · dlhd",
      "watch.optDlhdBackup": "dlhd backup",
      "watch.optDlhdBackupHint": "dlhd 24/7 feed — backup when primary is down",
