...
(function (global) {
  ...
  const DICT = {
    ar: {
      ...
      "home.recentTweetsTitle": "ترند X — آخر 24 ساعة",
      "home.recentTweetsLede": "أبرز التغريدات بالصور والفيديو من مباريات آخر 24 ساعة — مرتبة حسب التفاعل.",
      "home.recentTweetsCount": "{n} تغريدة",
    ...
    en: {
      ...
      "home.recentTweetsTitle": "Trending on X — last 24 hours",
      "home.recentTweetsLede": "Top photo and video posts from matches in the last 24 hours — ranked by engagement.",
      "home.recentTweetsCount": "{n} tweets",
