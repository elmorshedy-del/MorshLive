...
(function (global) {
  ...
  const NATIONAL_TEAM_REGISTRY = Object.freeze([
    ...
    { name: "England", ar: "إنجلترا", aliases: [], groups: ["priority_europe"] },
    { name: "France", ar: "فرنسا", aliases: [], groups: ["priority_europe"] },
    { name: "Germany", ar: "ألمانيا", aliases: [], groups: ["priority_europe"] },
    { name: "Spain", ar: "إسبانيا", aliases: [], groups: ["priority_europe"] },
    { name: "Italy", ar: "إيطاليا", aliases: [], groups: ["priority_europe"] },
    { name: "Portugal", ar: "البرتغال", aliases: [], groups: ["priority_europe"] },
    { name: "Netherlands", ar: "هولندا", aliases: [], groups: ["priority_europe"] },
    { name: "Belgium", ar: "بلجيكا", aliases: [], groups: ["priority_europe"] },
    { name: "Croatia", ar: "كرواتيا", aliases: [], groups: ["priority_europe"] },
