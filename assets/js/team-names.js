...
(function (global) {
  ...
  const NATIONAL_TEAM_REGISTRY = Object.freeze([
    ...
    // European national-team audience: EU-27 + the four UK home nations + Norway.
    // Keep this as canonical team metadata so Nations League, Euros, Euro
    // qualifying, UEFA World Cup qualifying, and friendlies share one policy.
    { name: "Austria", ar: "النمسا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Belgium", ar: "بلجيكا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Bulgaria", ar: "بلغاريا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Croatia", ar: "كرواتيا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Cyprus", ar: "قبرص", aliases: [], groups: ["eu_uk_norway"] },
    {
      name: "Czechia",
      ar: "التشيك",
    ...
    { name: "Denmark", ar: "الدنمارك", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Estonia", ar: "إستونيا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Finland", ar: "فنلندا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "France", ar: "فرنسا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Germany", ar: "ألمانيا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Greece", ar: "اليونان", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Hungary", ar: "المجر", aliases: [], groups: ["eu_uk_norway"] },
    {
    ...
    { name: "Italy", ar: "إيطاليا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Latvia", ar: "لاتفيا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Lithuania", ar: "ليتوانيا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Luxembourg", ar: "لوكسمبورغ", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Malta", ar: "مالطا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Netherlands", ar: "هولندا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Poland", ar: "بولندا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Portugal", ar: "البرتغال", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Romania", ar: "رومانيا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Slovakia", ar: "سلوفاكيا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Slovenia", ar: "سلوفينيا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Spain", ar: "إسبانيا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Sweden", ar: "السويد", aliases: [], groups: ["eu_uk_norway"] },
    { name: "England", ar: "إنجلترا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Scotland", ar: "اسكتلندا", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Wales", ar: "ويلز", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Northern Ireland", ar: "أيرلندا الشمالية", aliases: [], groups: ["eu_uk_norway"] },
    { name: "Norway", ar: "النرويج", aliases: [], groups: ["eu_uk_norway"] },
