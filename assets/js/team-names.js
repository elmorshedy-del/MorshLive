...
(function (global) {
  ...
  const NATIONAL_TEAM_REGISTRY = Object.freeze([
    ...
    // Bulgaria, Estonia, Finland, Latvia, Lithuania, Luxembourg, Malta, Romania, and Slovakia remain valid teams/opponents
    ...
    { name: "Cyprus", ar: "قبرص", aliases: [], groups: ["europe_surface"] },
    {
      ...
      groups: ["europe_surface"],
    },
    { name: "Denmark", ar: "الدنمارك", aliases: [], groups: ["europe_surface"] },
    { name: "Estonia", ar: "إستونيا", aliases: [], groups: [] },
    { name: "Finland", ar: "فنلندا", aliases: [], groups: [] },
    { name: "France", ar: "فرنسا", aliases: [], groups: ["europe_surface"] },
    { name: "Germany", ar: "ألمانيا", aliases: [], groups: ["europe_surface"] },
    { name: "Greece", ar: "اليونان", aliases: [], groups: ["europe_surface"] },
    { name: "Hungary", ar: "المجر", aliases: [], groups: ["europe_surface"] },
    {
    ...
    { name: "Italy", ar: "إيطاليا", aliases: [], groups: ["europe_surface"] },
    { name: "Latvia", ar: "لاتفيا", aliases: [], groups: [] },
    { name: "Lithuania", ar: "ليتوانيا", aliases: [], groups: [] },
    { name: "Luxembourg", ar: "لوكسمبورغ", aliases: [], groups: [] },
    { name: "Malta", ar: "مالطا", aliases: [], groups: [] },
    ...
    { name: "England", ar: "إنجلترا", aliases: [], groups: ["europe_surface"] },
    { name: "Scotland", ar: "اسكتلندا", aliases: [], groups: ["europe_surface"] },
    { name: "Wales", ar: "ويلز", aliases: [], groups: ["europe_surface"] },
    { name: "Northern Ireland", ar: "أيرلندا الشمالية", aliases: [], groups: ["europe_surface"] },
    { name: "Norway", ar: "النرويج", aliases: [], groups: ["europe_surface"] },
