...
window.KZ_CHANNEL_BINDINGS = {
  "version": 5,
  "updatedAt": "2026-06-26T20:01:35.817Z",
  "routing": {
    "mode": "probe-match",
    "note": "Probe worldkoora vip pages for slot routing only. Playback is always vip.worldkoora.com — no alternate hosts."
  },
  "vipSlotProbe": {
    "probedAt": "2026-06-26T20:01:35.816Z",
    "slots": {
      "vip1": "bein-sports-hd-2",
      "vip2": "bein-sports-hd-1"
    }
  },
  "embedBinding": {
    "bein-max-1": "vip2",
  ...
  "calibration": [
    {
      ...
      "issue": "France vs Norway showed beIN MAX 2 but played beIN MAX 1 stream.",
      "rootCause": "vip1/vip2 are inverted wrappers (vip1→beinmax2, vip2→beinmax1). Static channel→vip map assumed vipN carried beinmaxN.",
      "fix": "Probe vip slots at fetch time; store embedKey per match; browser resolves via match.embedKey + vipSlotProbe.",
      "liveAtTime": [
        {
