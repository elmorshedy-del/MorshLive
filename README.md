...
- `GET /api/xtream/live?limit=1000` — returns sanitized live-channel metadata. Optional filters: `portal=p1`, `category=<id-or-name>`, `q=<search>`.

The API never returns usernames, passwords, or raw portal credentials to the browser.
