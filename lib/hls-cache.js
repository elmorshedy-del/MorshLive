 ...
 *
 * Accept-Ranges must be none. Today's koralive playlist is disguised as
 * index.css; Cloudflare adds Accept-Ranges: bytes, hls.js switches to
 * Range requests, and the edge answers 206 in a tight loop — a few
 * segments play, then the same window repeats.
 */
