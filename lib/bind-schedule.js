 ...
 * Saudi Pro League fixtures in that UTC window. One timer per ESPN id
 * (T-15, then T-7, then kickoff). If T-15 was missed, start that pass as
 * soon as you can. Do not arm a finished match.
 */

export const BIND_COMPETITION_KEYS = Object.freeze(["epl", "laliga", "spl"]);
export const BIND_LEAGUE_SLUGS = Object.freeze(["eng.1", "esp.1", "ksa.1"]);
