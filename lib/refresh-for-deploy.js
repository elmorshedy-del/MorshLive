...
export const FULL_CRAWL_STEPS = Object.freeze([
  ...
  "scripts/build-wc-seo-pages.mjs",
  "scripts/verify-channel-bindings.js",
]);

// `generated/` is built, never committed, and `_redirects` points every
// /world-cup-2026/ URL into it — so the World Cup build has to run on CI too,
// or all 152 routes 404 on the next deploy.
