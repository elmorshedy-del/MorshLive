...
/** Stay ~8s behind whether segments are 0.5s or 2s. Count-based sync hitch-pauses on 0.5s. */
...
/** Wait for ~4s of 0.5s segments (or 16s of 2s) before starting so the first hop does not underrun. */
