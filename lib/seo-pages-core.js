...
export const LEAGUE_META = Object.freeze({
  ...
  spl: {
    ...
    titleAr: "مباريات الدوري السعودي اليوم مباشر — المواعيد والقنوات",
    descriptionAr:
      "مباريات الدوري السعودي اليوم مباشر مع المواعيد والتوقيت المحلي والنتائج والقنوات والمعلّقين وروابط تفاصيل كل مباراة على كورة زيرو.",
  },
  ucl: {
