...
describe("international audience filtering", () => {
  ...
  it("keeps international friendlies involving GCC, North Africa, Brazil, or Argentina", () => {
    expect(shouldIncludeAudienceMatch({ competition: "friendly", home: "Brazil", away: "Australia" })).toBe(true);
    expect(shouldIncludeAudienceMatch({ competition: "friendly", home: "Argentina", away: "Bolivia" })).toBe(true);
    expect(shouldIncludeAudienceMatch({ competition: "friendly", home: "Saudi Arabia", away: "Kuwait" })).toBe(true);
    ...
    expect(shouldIncludeAudienceMatch({ competition: "friendly", home: "Japan", away: "Uruguay" })).toBe(false);
  });
